  ...
  return (
    <div>
      <section className="bg-background px-6 py-24">
            ...
            <div>
              ...
              <div className="animate-fade-in delay-100">
                <div className="isolate">
                  <a
                    className="ring-offset-background focus-visible:ring-ring [&_svg]:size-4 bg-linear-to-r shadow-modern hover:shadow-modern-lg bg-primary text-primary-foreground hover:bg-primary/90 group relative z-20 inline-flex h-11 items-center justify-center gap-2 whitespace-nowrap rounded-full from-purple-500 to-blue-500 px-6 py-5 text-base font-medium transition-all duration-300 hover:scale-[1.05] hover:from-purple-600 hover:to-blue-600 hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0"
                    href="/onboarding"
                  >
                    Try now
                    <svg
        ...
        <div className="hidden overflow-hidden sm:mt-12 md:mt-0 md:block ">
          {/* Annimation */}
          <WebAnimation />
        </div>
